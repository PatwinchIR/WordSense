...
class ButtonDiv extends Component {
    ...
    render () {
        ...
        <Button onClick={this.handleOnMouseDown} rightIcon="arrow-right" intent="success" text="Next Utterance">
            {this.props.children}
        </Button> :
        <Button onClick={this.handleOnMouseDown} icon="arrow-left" intent="warning" text="Previous Utterance">
            {this.props.children}
        </Button>;
    }
}
